import {
  Box, Container, Heading, GridItem, Button
        ...
        >
          <GridItem colSpan={{ base: 3 }}>
            ...
            >
              ...
              <Heading fontSize={{ base: '30px', sm: '20px', md: '25px' }} color='blue.500'>
              ...
              <Box textAlign={'center'}>
            <Button mt={5} width='200px' colorScheme='blue' onClick={() => onImageCownload()} mr={3}>
                Lưu về máy
              </Button>
            </Box>
            </Box>
